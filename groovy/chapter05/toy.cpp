...
namespace
{
    ...
    class ForExprAST : public ExprAST {
        std::unique_ptr<ExprAST> Init; // Inicijalizacija: npr. "int i = 0"
        std::unique_ptr<ExprAST> Cond; // Uslov: npr. "i < 10"
        std::unique_ptr<ExprAST> Inc;  // Inkrementacija: npr. "i = i + 1"
        std::vector<std::unique_ptr<ExprAST>> Body; // Telo petlje
